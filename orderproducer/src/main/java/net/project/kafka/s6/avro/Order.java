 ...
 */
package net.project.kafka.s6.avro;
...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1284455194147877647L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Order\",\"namespace\":\"net.project.kafka.s6.avro\",\"fields\":[{\"name\":\"customerName\",\"type\":\"string\"},{\"name\":\"product\",\"type\":\"string\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static net.project.kafka.s6.avro.Order.Builder newBuilder() {
    return new net.project.kafka.s6.avro.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static net.project.kafka.s6.avro.Order.Builder newBuilder(net.project.kafka.s6.avro.Order.Builder other) {
    if (other == null) {
      return new net.project.kafka.s6.avro.Order.Builder();
    } else {
      return new net.project.kafka.s6.avro.Order.Builder(other);
    }
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static net.project.kafka.s6.avro.Order.Builder newBuilder(net.project.kafka.s6.avro.Order other) {
    if (other == null) {
      return new net.project.kafka.s6.avro.Order.Builder();
    } else {
      return new net.project.kafka.s6.avro.Order.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(net.project.kafka.s6.avro.Order.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(net.project.kafka.s6.avro.Order other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.customerName)) {
        this.customerName = data().deepCopy(fields()[0].schema(), other.customerName);
    ...
    /**
      ...
      * @return This builder.
      */
    public net.project.kafka.s6.avro.Order.Builder setCustomerName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.project.kafka.s6.avro.Order.Builder clearCustomerName() {
      customerName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.project.kafka.s6.avro.Order.Builder setProduct(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.project.kafka.s6.avro.Order.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public net.project.kafka.s6.avro.Order.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public net.project.kafka.s6.avro.Order.Builder clearQuantity() {
